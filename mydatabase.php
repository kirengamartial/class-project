...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"test_db",token:"536540526736374f5e59646927614c38",text_dir:"ltr",LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:false,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.0",auth_type:"config",user:"root"});
...
<br><br>
    ...
    <table class="table table-borderless text-start w-75 mx-auto">
        <tr>
            <td><div class="alert alert-danger" role="alert"><h1>Error</h1><p>
...
<code>Cannot connect: invalid settings.</code><br></div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> mysqli::real_connect(): (HY000/1045): Access denied for user &#039;&#039;@&#039;localhost&#039; (using password: NO)</div><div class="alert alert-danger" role="alert"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> phpMyAdmin tried to connect to the MySQL server, and the server rejected the connection. You should check the host, username and password in your configuration and make sure that they correspond to the information given by the administrator of the MySQL server.</div></td>
        </tr>
        <tr>
            <td>
<a href="index.php?route=/" class="btn btn-primary mt-1 mb-1 disableAjax">Retry to connect</a>
</td>
        </tr>
</table>
  </div>
